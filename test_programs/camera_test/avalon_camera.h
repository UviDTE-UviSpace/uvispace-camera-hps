...
#define ADDR_START_ROW      0x05
#define ADDR_START_COLUMN   0x06
#define ADDR_ROW_SIZE       0x07
#define ADDR_COLUMN_SIZE    0x08
#define ADDR_ROW_MODE       0x09
#define ADDR_COLUMN_MODE    0x0a
#define ADDR_EXPOSURE       0x0b

#define ADDR_WIDTH          0x0c
#define ADDR_HEIGHT         0x0d

#define CAMERA_SOFT_RESET       0x0e
